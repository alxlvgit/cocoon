    ...
    <div className="h-96 bg-main-bg col-span-2 w-full rounded-2xl p-4 sm:p-10 text-center flex flex-col  align-middle items-center justify-between shadow-xl">
      {pickedCareer && skillsMatchedPercentage ? (
        ...
        <div className="items-center">
          <h1 className="text-center mb-12 font-bold  text-md">
            Career Path: Please pick your career path to start analysis
          </h1>
            <div className="bg-bright-main rounded-2xl p-4">
            <p className="text-wra m-4">No path has been selected, upload your resume to start</p>
              <div className="justify-center items-center text-md m-4">
                <Link
                  href="/careers"
