...
const PathsSelection = ({
  ...
  return (
    <>
      <div className="bg-main-bg h-full relative overflow-y-hidden w-full rounded-2xl mx-auto pt-8 pb-4 pl-8 pr-8 flex flex-col items-center justify-stretch" style={{ height: '980px' }}>
